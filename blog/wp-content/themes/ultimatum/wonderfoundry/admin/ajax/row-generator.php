...
<div class='cssmenu'>
  <ul>
     <li class='active'><i class="icon-edit"></i>
        <ul>
...
<div class="col_container">
	<div class="poppover">
		...
		<a class="close-popover thickbox" href="<?php echo admin_url();?>index.php?page=ultimatum-css-gen&layoutid=<?php echo $_GET["layoutid"];?>&container=<?php echo 'col-'.$row.'-'.$col;?>&modal=true&TB_iframe=1&width=640&height=380"><i class="icon-cog"></i></a>
	</div>
