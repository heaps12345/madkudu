...
$options = array(
	...
	array(
		...
		/*array(
			"name" => __("Ultimatum SEO", 'ultimatum'),
			"desc" => __('If this option is on, Ultimatum will enable your SEO options for each single page or post or post types. Turn this off if you are using another SEO tool such as All in one SEO ', 'ultimatum'),
			"id" => "ultimatum_seo",
			"default" => false,
			"type" => "toggle"
		),*/
		...
		array(
				"name" => __("Post Ordering", 'ultimatum'),
				"id" => "ultimatum_pto",
				"desc" => __('We have included Post Ordering plugin so that you may order your posts in front end with ease. ', 'ultimatum'),
				"default" => false,
				"type" => "toggle"
		),
		array(
