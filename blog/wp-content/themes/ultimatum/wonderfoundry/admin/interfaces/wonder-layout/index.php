...
function ultimatum_list_layouts(){
	...
	<h2><?php _e('LAYOUTS','ultimatum')?> - <small><em>(<?php echo $themeinfo->name;?>)</em></small>
	 ...
	 <a class="add-new-h2 thickbox" href="<?php echo './index.php?page=layout-assigner&theme='.$_REQUEST['theme'].'&modal=true&TB_iframe=1&width=640&height=380'; ?>"><?php _e('Assign Layouts','ultimatum');?></a>
...
?>
<div id="blocker">
<div><h1><i class="icon-save"></i> Saving..</h1></div>
</div>
 			...
 			<div class="navbar-inner">
 				...
 				<ul class="nav">
 					...
 					<li class="dropdown">
 						...
 						<ul class="dropdown-menu" role="menu" >
 						<li><a href="<?php echo ULTIMATUM_ADMIN_URL;?>/interfaces/wonder-css/custom-css-editor.php?template_id=<?php echo $layout['theme'];?>&modal=true&TB_iframe=1&width=640&height=380" class="thickbox" title="<?php _e('Type your Custom CSS','ultimatum');?>"><?php _e('Template wide Custom CSS','ultimatum');?></a></li>
 						<li><a class="thickbox"  href="<?php echo ULTIMATUM_ADMIN_URL; ?>/interfaces/wonder-css/custom-css-editor.php?layout_id=<?php echo $layout["id"];?>&modal=true&TB_iframe=1&width=640&height=380" title="<?php _e('Type your Custom CSS','ultimatum');?>">
			...
			<?php if($layoutid){?>
				...
				<div id="widgets-left">
					...
					<div id="available-widgets" class="widgets-holder-wrap">
						<div class="sidebar-name">
						<div class="sidebar-name-arrow"><br /></div>
						<h3><?php _e('Elements','ultimatum');?> <span id="removing-widget"><?php _ex('Deactivate', 'removing-widget'); ?> <span></span></span></h3></div>
	...
	<div id="layout-<?php echo $fetch["id"];?>" data-id="layout-<?php echo $fetch["id"];?>" class="partial_layo">
		...
		<div class="row-container partial_layout" style="height:55px">
			<div class="row-options">
				...
				<div class="poppover">
					<i class="icon-trash delete-part"></i>
				</div>
			</div>
