...
<form id="create-template" action="" method="post" class="validate">
	...
	<tr>
		...
		<td>
			<select name="gridwork" id="gridwork">
				<option value="ultimatum" <?php selected($template->gridwork,'ultimatum'); ?>>Ultimatum</option>
				<option value="tbs" <?php selected($template->gridwork,'tbs'); ?>>Twitter Bootstrap</option>
			</select>
		</td>
	</tr>
	<tr class="tbs griddetails <?php if($template->gridwork=='tbs') { echo 'stored';}?>">
		...
		<td>
			<select name="swatch">
				...
				<?php do_action('ultimatum_bootstrap_select_option',$template);?>
			</select>
		</td>
	</tr>
	<tr>
