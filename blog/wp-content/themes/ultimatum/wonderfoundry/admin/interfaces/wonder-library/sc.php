...
<div class="ultadmnavi" style="position:absolute;top:0;width:100%;margin-right:25px;">
 		<div class="navbar">
 			<div class="navbar-inner">
 				<a class="brand" href="<?php echo $defpage;?>"><i class="icon-book"></i>&nbsp;LIBRARY</a>
 				<ul class="nav">
 					
 					<li <?php if($task=='fonts') echo ' class="active"' ;?>>
 						<a href="admin.php?page=wonder-fonts"><i class="icon-font"></i><?php _e('Fonts','ultimatum');?></a>
 					</li>
 					<li <?php if($task=="icons") echo ' class="active"' ;?>>
 						<a href="<?php echo $defpage.'&task=icons'; ?>"><i class="icon-lightbulb"></i><?php _e('Icons','ultimatum');?></a>
 					</li>
 					<li <?php if($task=="sc") echo ' class="active"' ;?>>
 						<a href="<?php echo $defpage.'&task=sc'; ?>"><i class="icon-magic"></i><?php _e('Shortcodes','ultimatum');?></a>
 					</li>
 				</ul>	
 			</div>
 		</div>
...
if($results){
	...
	<div class="btn-group">
	<button " style="height:30px !important" class="btn btn-danger" onClick="return confirmSubmit()" ><i class="icon-trash"></i></button>
	<a href="'.$link.'" class="thickbox btn btn-primary"><i class="icon-external-link"></i> '
