...
<div class="ultadmnavi" style="position:absolute;top:0;width:100%;margin-right:25px;">
 		<div class="navbar">
 			<div class="navbar-inner">
 				<a class="brand" href=""><i class="icon-book"></i>&nbsp;LIBRARY</a>
 				<ul class="nav">
...
foreach($icons as $icon){
	...
	if($form){
	echo '<div><form action="" method="post"><input type="hidden" name="action" value="delete" /><input type="hidden" name="icon" value="'.$icon.'" /><button class="btn btn-danger "><i class="icon-trash"></i>&nbsp;Delete</button></form></div>';
	}
	echo '</div>';
}