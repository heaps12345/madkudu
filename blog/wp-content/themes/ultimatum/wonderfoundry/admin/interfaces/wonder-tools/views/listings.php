		...
		<?php 
			...
			<li class="listing-item<?php echo $listing_class; ?>">
				...
				<div class="install_wrap">
					...
					<?php
					if ($installed) {
						/* ?><span class="wpmu-button icon installed"><i class="icon-ok icon-large"></i><?php _e('INSTALLED', 'ultimatum'); ?></span><?php */
					} else  if ($url = ultimatum_auto_install_url($project['id'])) {
						?><a href="<?php echo $url; ?>" data-downloading="<?php esc_attr_e(__('DOWNLOADING...', 'ultimatum')); ?>" data-installing="<?php esc_attr_e(__('INSTALLING...', 'ultimatum')); ?>" class="ultimatum-button button button-primary icon <?php echo $action_class; ?>"><i class="icon-download-alt icon-large"></i> <?php _e('INSTALL', 'ultimatum'); ?></a><?php
					} 
					?>
					</span>
					<?php if ($installed) { ?>
					<div class="action_links">
						...
						<a href="<?php echo $deactivate_url; ?>" class="button button-primary"><i class="icon-off"></i> <?php echo is_network_admin() ? __('Network Deactivate', 'ultimatum') : __('Deactivate', 'ultimatum'); ?></a>
						<?php } else if ($activate_url) { ?>
						<a href="<?php echo $activate_url; ?>" class="button button-primary"><i class="icon-off"></i> <?php echo is_network_admin() ? __('Network Activate', 'ultimatum') : __('Activate', 'ultimatum'); ?></a>
						<?php } ?>
					</div>
