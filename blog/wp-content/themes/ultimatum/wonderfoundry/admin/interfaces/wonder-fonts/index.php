	...
	<div class="ultadmnavi" style="position:absolute;top:0;width:100%;margin-right:25px;">
 		<div class="navbar" id="ult-nav">
 			<div class="navbar-inner">
 				<a class="brand" href="admin.php?page=wonder-library"><i class="icon-book"></i>&nbsp;LIBRARY</a>
 				<ul class="nav">
 				
 					<li <?php echo ' class="active dropdown"' ;?>>
 						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-font"></i><?php _e('Fonts','ultimatum');?><b class="caret"></b></a>
 					...
 					<li <?php if($task=="icons") echo ' class="active"' ;?>>
 						<a href="<?php echo 'admin.php?page=wonder-library&task=icons'; ?>"><i class="icon-lightbulb"></i><?php _e('Icons','ultimatum');?></a>
 					</li>
 				</ul>	
 			</div>
 		</div>
...
if(isset($_GET['page']) &&  isset($_GET['task']) &&  $_GET['page']=='wonder-fonts' && $_GET["task"] == 'google'){
	...
	function get_google_fonts(){
		...
		$url     = ULTIMATUM_API.'/google_fonts.php';
		$options = apply_filters(
		'ultimatum_update_remote_post_options',
		array(
				'body' => array(
						'ultimatum_version' => ULTIMATUM_VERSION,
	...
	//print_r($response);
	$google_webfonts = wp_remote_retrieve_body( $response );
	$google_webfonts = maybe_unserialize( $google_webfonts );
