	 		...
	 		<div class="navbar" id="ult-nav">
	 			<div class="navbar-inner">
	 				...
	 				<ul class="nav pull-right">
				 		<li class=""><button class="btn-info btn" id="setting-submit"><i class="icon-save"></i> Save Changes</button></li>
				 	</ul>
	 			</div>
	 		</div>
	 	</div>
 		...
 		<div class="navbar" id="ult-nav">
 			<div class="navbar-inner">
 				...
 				<ul class="nav">
 					...
 					<li class="dropdown <?php if($task=="hm" || $task=="hmm"|| $task=="hdm"|| $task=="vm"|| $task=="vmm"|| $task=="vdm") {echo ' active' ;}?>" >
 					...
 					<li class="dropdown">
 						...
 						<ul class="dropdown-menu" role="menu" >
 						<li><a href="<?php echo ULTIMATUM_ADMIN_URL;?>/interfaces/wonder-css/custom-css-editor.php?template_id=<?php echo $fetch->theme;?>&TB_iframe=1&width=770&height=480" class="thickbox" title="<?php _e('Type your Custom CSS', 'ultimatum');?>"><?php _e('Template wide Custom CSS', 'ultimatum');?></a></li>
 						<li><a class="thickbox"  href="<?php echo ULTIMATUM_ADMIN_URL; ?>/interfaces/wonder-css/custom-css-editor.php?layout_id=<?php echo $_GET["layout_id"];?>&TB_iframe=1&width=770&height=480" title="<?php _e('Type your Custom CSS', 'ultimatum');?>">
 					...
 					<?php } else { ?>
 					<li><a href="<?php echo ULTIMATUM_ADMIN_URL;?>/interfaces/wonder-css/custom-css-editor.php?template_id=<?php echo $_GET["template_id"];?>&TB_iframe=1&width=770&height=480" class="thickbox" title="<?php _e('Type your Custom CSS', 'ultimatum');?>"><?php _e('Template wide Custom CSS', 'ultimatum');?></a></li>
 					<li>
 					<a href="javascript: history.go(-1)">Back</a>
 					</li>
 					<?php } ?>
