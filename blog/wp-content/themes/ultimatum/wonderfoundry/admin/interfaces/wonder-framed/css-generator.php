	...
	<table width="100%"  class="widefat" cellspacing="0">
		...
		<tr valign="top">
			...
			<td colspan="2">
				...
				<input id="bg_color" class="ult-color-field" name="cssvar<?php echo '['.$_GET["container"].']'; ?>[general][background-color]" type="text" size="6"  value="<?php echo $value[$_GET["container"]]["general"]['background-color'];?>"/>
