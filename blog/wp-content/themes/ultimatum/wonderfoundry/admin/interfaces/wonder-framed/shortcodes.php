...
function codeGeneratorHome($uri){
	...
	<div id="container">
		...
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-4-48px.png';?>" />
		25/25/25/25
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=mcols&row_style=2" class="column">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-3-48px.png';?>" />
		33/33/33
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=mcols&row_style=3" class="column">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-2-48px.png';?>" />
		50/50
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=mcols&row_style=4" class="column">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-2d4-3-48px.png';?>" />
		25/25/50
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=mcols&row_style=5" class="column">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-2d4-1-48px.png';?>" />
		50/25/25
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=mcols&row_style=6" class="column">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-2d4-2-48px.png';?>" />
		25/50/25
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=mcols&row_style=7" class="column">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-3d4-2-48px.png';?>" />
		25/75
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=mcols&row_style=8" class="column">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-3d4-1-48px.png';?>" />
		75/25
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=mcols&row_style=9" class="column">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-2d3-1-48px.png';?>" />
		33/66
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=mcols&row_style=10" class="column">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/cols-2d3-2-48px.png';?>" />
		66/33
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=tabs" class="toggler">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/tabs-48px.png';?>" />
		Tabs
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=toggle" class="toggler">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/heading-48px.png';?>" />
		Toggle
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=acc" class="toggler">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/accordion-48px.png';?>" />
		Accordion
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=boxes&type=roundbox" class="typography">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/ultimatum_48.png';?>" />
		Rounded Corner Box
		</div>
		</a>
		...
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/list-48px.png';?>" />
		List
		</div>
		</a>
		<a href="<?php echo $uri;?>&task=quote" class="typography">
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/testimonials-48px.png';?>" />
		Quote
		</div>
		</a>
		...
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/googlemap-48px.png';?>" />
		Google Map
		</div>
		</a>
		...
		<div class="codes">
		<img src="<?php echo ULTIMATUM_URL.'/wonderfoundry/addons/plugins/ether-forms/admin/media/images/video-48px.png';?>" />
		Video
		</div>
		</a>
