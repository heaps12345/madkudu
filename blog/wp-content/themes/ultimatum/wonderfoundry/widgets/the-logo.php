 ...
 function widget($args, $instance) {
    if(is_single()){
       ...
       if($instance["logotext"]){
       		echo '<'.$ltag.'><a id="logo" class="logo" href="'.get_bloginfo('url').'">'.$instance["logotext"].'</a></'.$ltag.'>';
       } else {
       		echo '<'.$ltag.'><a id="logo" class="logo" href="'.get_bloginfo('url').'">'.get_bloginfo().'</a></'.$ltag.'>';
       }
       ...
       //
       		...
       		if($instance["logoimage"]){
       		 ...
       		 echo '<'.$ltag.'><a href="'.get_bloginfo('url').'" class="logo"><img src="'.$logo_src.'" alt="'.get_bloginfo().'"/></a></'.$ltag.'>'; 
       }
       echo '</div>';
    }
