...
function shortcode_toggle($atts, $content = null, $code) {
	...
	$html = 
<<<HTML
<div class="accordion toggler" id="{$randomnr}">
  <div class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#{$randomnr}" href="#{$tabid}">
      {$title}
      </a>
    </div>
    <div id="{$tabid}" class="accordion-body collapse">
...
function shortcode_accordion( $atts, $content = null ) {
    ...
    $accordion_output .= '<div class="accordion ult_accordion" id="'.$randomnr.'">';
	...
	$accordion_output .= '<div class="accordion-group">
							<div class="accordion-heading">
								<a href="#'.$tabid.'" class="accordion-toggle'.$active.'" data-toggle="collapse" data-parent="#'.$randomnr.'">'.$accordion_toggle_attr_array['title'].'</a>
							</div>';
     $accordion_output .= '<div id="'.$tabid.'" class="accordion-body collapse'.$in.'">
     						<div class="accordion-inner">'.$accordion_toggle_attr_array['content'].'</div>
     					  </div></div>';
     $i++;
           }
